...
const deliveries = [
  [
    ...
    null,
    null,
    transactions[1].pickup,
    transactions[1].dropoff,
    'open',
    null,
  ],
  [
    ...
    now,
    now,
    transactions[2].pickup,
    transactions[2].dropoff,
    'delivered',
    now,
  ],
  [
    ...
    now,
    now,
    transactions[3].pickup,
    transactions[3].dropoff,
    'delivered',
    now,
  ],
  [
    ...
    now,
    now,
    transactions[4].pickup,
    transactions[4].dropoff,
    'delivered',
    now,
  ],
  [
...
try {
  ...
  console.log(
    `Seeded ${users.length} users, ${accountAddresses.length} addresses, ${books.length} books, ${transactions.length} transactions.`,
  )
